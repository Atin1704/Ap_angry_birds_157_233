...
public class Normal_pig extends Pig implements Serializable {
    ...
    public Normal_pig(World world, BodyRemovalManager bodyRemovalManager, Normal_pig pig) {
        super(world, bodyRemovalManager, "Normal_pig.png", pig.xPos, pig.yPos, pig.width, pig.height);
