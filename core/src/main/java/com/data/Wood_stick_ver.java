...
public class Wood_stick_ver extends Obstacle implements Serializable {
    ...
    public Wood_stick_ver(World world, BodyRemovalManager bodyRemovalManager, Wood_stick_ver block) {
        super(world, bodyRemovalManager, "Wooden_Stick_Vertical.png", block.xPos,block.yPos, block.width, block.height);
