...
public class Glass_block extends Obstacle implements Serializable {
    ...
    public Glass_block(World world, BodyRemovalManager bodyRemovalManager, Glass_block block) {
        super(world, bodyRemovalManager, "Glass_block.png", block.xPos,block.yPos, block.width, block.height);
