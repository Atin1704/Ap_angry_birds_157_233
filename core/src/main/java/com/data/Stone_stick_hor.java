...
public class Stone_stick_hor extends Obstacle implements Serializable {
    ...
    public Stone_stick_hor(World world, BodyRemovalManager brm, float xPos, float yPos, float width, float height) {
        ...
        this.image = new Texture("Stone_Stick_Horizontal.png");
        this.health = 23.0f;
    ...
    public Stone_stick_hor(World world, BodyRemovalManager bodyRemovalManager, Stone_stick_hor block) {
        super(world, bodyRemovalManager, "Stone_Stick_Horizontal.png", block.xPos,block.yPos, block.width, block.height);
